...
# mylist[2].setevaluation()
 ...
 #cv2.putText(image,"COUNT:"+str(mylist[0].vehiclescount),(180,50), font, 1,(255,255,0),2,cv2.LINE_AA)

 cv2.putText(image,str(int(1+mylist[2].releasetime)),(80,60), font, 1,(255,255,0),2,cv2.LINE_AA)
 ...
 #cv2.putText(image,"COUNT:"+str(mylist[1].vehiclescount),(180,50), font, 1,(255,255,0),2,cv2.LINE_AA)
 ...
 #cv2.putText(image,"COUNT:"+str(mylist[2].vehiclescount),(180,50), font, 1,(255,255,0),2,cv2.LINE_AA)
 ...
 # cv2.putText(image,"COUNT:"+str(mylist[3].vehiclescount),(180,50), font, 1,(255,255,0),2,cv2.LINE_AA)
